...
export default function AuditSidebar({ stats }: { stats: AuditStats }) {
  ...
  return (
    <>
      ...
      >
        <div className="mb-6">
          <span className="font-fraunces text-lg font-semibold text-[#064E3B]">
            GetLostRevenue
          </span>
        </div>
        <div className="mb-6 rounded-xl border border-gray-200 bg-gray-50 p-3">
          <p className="font-fraunces text-base text-slate-900">
              ...
              return (
                <li key={l.id}>
                  ...
                  >
                    ...
                    <span
                      className={`inline-block h-2 w-2 rounded-full ${l.pastille}`}
                      aria-hidden
                    />
                    {l.label}
                  </a>
            ...
            {LINKS.map((l) => {
              ...
              return (
                <li key={l.id}>
                  ...
                  >
                    <span
                      className={`inline-block h-1.5 w-1.5 rounded-full ${l.pastille}`}
                      aria-hidden
                    />
                    {l.label}
                  </a>
